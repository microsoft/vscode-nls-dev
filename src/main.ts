...
export function processFile(contents: string, sourceMap?: string): { contents: string, sourceMap: string, bundle: MessageBundle, errors: string[] } {
	...
	let rawSourceMap: RawSourceMap = sourceMap ? JSON.parse(sourceMap) : undefined;
